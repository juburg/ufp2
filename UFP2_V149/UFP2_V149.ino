...
// Release history:
//
// V1.50 20181230 bugfix: range test re-implementetd (lost in V1.46)
//                feature: jumper for hw-versions with batt measurement modification (vmea)
//                feature: display update in background only when no signal present
// V1.48 20181213 Relais driver control  moved from D9 to D22 (MISO); D9 aka A7 measures the battery voltage
